...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->integer('invoice_limit')->default(30); // Free: 20 invoice/bulan
            $table->integer('invoice_count_this_month')->default(0);
            $table->integer('product_limit')->default(20); // Free: 20 produk
            ...
            // Indexes
            $table->index('email');
            $table->index(['subscription_plan', 'is_active']);
        });
